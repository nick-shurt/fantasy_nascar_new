...
$getRaceData = "SELECT race_id, date FROM races_2026 WHERE closed = 0 LIMIT 1";
...
if ($isRaceOver) {
    $request = "https://cf.nascar.com/cacher/2026/1/" . $raceId . "/weekend-feed.json";
...
$getRaces = "SELECT * FROM races_2026 WHERE closed = 1";
