...
$corey_heim = new Season_Driver("Corey Heim");
...
$getRaceData = "SELECT * FROM teams_2026";
...
$team_steve = new Team($team_names[260],$drivers1[260],$drivers2[260],$drivers3[260],$drivers4[260]);
$team_jim = new Team($team_names[261],$drivers1[261],$drivers2[261],$drivers3[261],$drivers4[261]);
$team_nick = new Team($team_names[262],$drivers1[262],$drivers2[262],$drivers3[262],$drivers4[262]);
$team_rachel = new Team($team_names[263],$drivers1[263],$drivers2[263],$drivers3[263],$drivers4[263]);
$team_mike = new Team($team_names[264],$drivers1[264],$drivers2[264],$drivers3[264],$drivers4[264]);
$team_donna = new Team($team_names[265],$drivers1[265],$drivers2[265],$drivers3[265],$drivers4[265]);
$team_jru = new Team($team_names[266],$drivers1[266],$drivers2[266],$drivers3[266],$drivers4[266]);
$team_joey = new Team($team_names[267],$drivers1[267],$drivers2[267],$drivers3[267],$drivers4[267]);
...
$team_standings = array($team_steve,$team_jim,$team_nick,$team_rachel,$team_mike,$team_donna,$team_jru,$team_joey,$team_chives,$team_matt);
