...
$team_jim = new Team("Team Jim","Chase Elliott","Erik Jones","Trevor Bayne","Dummy");
...
$team_jim = new Team("Team Jim","Chase Elliott","Erik Jones","Trevor Bayne","Cole Whitt");
...
$team_jim = new Team("Team Jim","Chase Elliott","Erik Jones","Trevor Bayne","Cole Whitt");
$team_matt = new Team("Team Matt","Brad Keselowski","Austin Dillon","Ryan Blaney","Carl Edwards");
$team_joey = new Team("Team Joey","Martin Truex Jr","Jamie McMurray","Aric Almirola","Darrell Wallace Jr");
$team_rachel = new Team("Team Rachel","Joey Logano","Matt Kenseth","Landon Cassill","Matt DiBenedetto");
$team_mike = new Team("Team Mike","Dale Earnhardt Jr","Ty Dillon","Chris Buescher","David Ragan");
$team_chives = new Team("Team Chives","Kurt Busch","Kyle Larson","Gray Gaulding","Jeffrey Earnhardt");
$team_docks = new Team("Team Docks","Jimmie Johnson","Ricky Stenhouse Jr","Danica Patrick","-- Empty --");
...
$team_matt = new Team("#4 Team Matt","Brad Keselowski","Austin Dillon","Ryan Blaney","Carl Edwards");
$team_docks = new Team("#5 Team Docks","Jimmie Johnson","Ricky Stenhouse Jr","Danica Patrick","-- Empty --");

$wildcard_teams = array($team_matt, $team_docks);

$team_donna = new Team("#1 Team Donna","Denny Hamlin","Daniel Suarez","Clint Bowyer","Michael McDowell");
$team_matt = new Team("#4 Team Matt","Brad Keselowski","Austin Dillon","Ryan Blaney","Carl Edwards");
$team_jru = new Team("#2 Team Jru","Kevin Harvick","Ryan Newman","Paul Menard","Casey Mears");
$team_joey = new Team("#3 Team Joey","Martin Truex Jr","Jamie McMurray","Aric Almirola","Darrell Wallace Jr");

$semifinal_teams = array($team_donna, $team_matt, $team_jru, $team_joey);

$team_joey = new Team("#3 Team Joey","Martin Truex Jr","Jamie McMurray","Aric Almirola","Darrell Wallace Jr");
$team_matt = new Team("#4 Team Matt","Brad Keselowski","Austin Dillon","Ryan Blaney","Carl Edwards");

$championship_teams = array($team_joey, $team_matt);
