...
$getRaceData = "SELECT race_id, date FROM races_2024 WHERE closed = 0 LIMIT 1";
...
//if ($rd_month == $td_month && $rd_day == $td_day) {
    $key = "IFNXBPl4WI66uhuJYmxZaaySuKH4y43j9w45poA9";
...
$getRaces = "SELECT * FROM races_2024 WHERE closed = 1";
